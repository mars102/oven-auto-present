...
$(document).ready(function(){
	...
	$(".smallcompany").on("click"," .checkcompany",function(){
		...
		if($(this).attr("data-input")=="0")
		{
			...
			parent.parent().height(parent.parent().find(".company-text").outerHeight()+parent.parent().outerHeight()+20);
			parent.parent().find(".company-text").css({"display":"block"});
		}
		else{
			...
			disabledsmall($(this),parent);
			parent.parent().height(parent.height()+16);
			parent.parent().find(".company-text").css({"display":"none"});
		}
