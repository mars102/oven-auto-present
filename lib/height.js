...
function disabledsmall(obj,parent)
{
	...
	if(obj.attr("data-main")=="1")
	{
		if(obj.attr("data-input")=="1")
		{
			...
			$(".vigoda").append("<div class='addingcompany' id='"+obj.attr("data-id")+"'>"+parent.find(".ofer").html()+obj.html()+"</div>");
			$(".vigoda").append("<div class='clearfix'></div>");
			//$(".company-total-price").html(price-parseInt(obj.attr("data-skidka"))-parseInt(obj.attr("data-bydget")));
...
$(document).ready(function(){
	...
	$(".company").each(function(i,item){
		...
		$(this).find(".ofer").css({"position":"absolute","bottom":"30px","left":"15px","width":width});
	...
	$("body").on("click",".smallcompany .checkcompany",function(){
		...
		if($(this).attr("data-input")=="0")
		{
			...
			parent.css({"border-color":"#fc3","border-width":"3px"});
			$(".vigoda").append("<div class='addingcompany' id='"+$(this).attr("data-id")+"'>"+parent.find(".ofer").html()+$(this).html()+"</div>");
			$(".vigoda").append("<div class='clearfix'></div>");
