...
$(document).ready(function(){
    ...
    $(window).scroll(function() {
    	//if(($('.company-border').offset().top+$('.company-border').height()+150)<areabottom)
    	//{
    	if(typeof(defTop) != "undefined" && defTop !== null) {
    		if($(window).scrollTop() > areabottom-$('.company-border').height()-230){
	            ...
	            $('.company-border').stop().animate({marginTop: $(window).scrollTop() - offset.top + topPadding});
	        }
	...
	console.log(areabottom+" "+area.top+" "+block.height()+" "+defTop.top);
	...
	$(window).scroll(function(){
		...
		if(typeof(defTop) != "undefined" && defTop !== null) {
			...
			{
				block.offset({top:$(this).scrollTop()});
			}
			else if(defTop.top >= $(this).scrollTop()){
				block.offset({top:defTop.top});
				console.log($(this).scrollTop()+" "+defTop.top);
			}
		}
	});*/
