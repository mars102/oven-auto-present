...
$(document).ready(function(){
   ...
   $(".available-star,#car-select").mouseover(function(){
     
   
        if(!this.childNodes[1].childNodes[1].classList.contains('effect-3')&&this.childNodes[1].childNodes[1].classList.contains('icon-img')){
           $(this).find(".hovicon").toggleClass('effect-3 sub-b'); 
    ...
    $(".available-star,#car-select").mousedown(function(){
        ...
        if($(this).attr('check')=="false"){
            ...
            if(this.childNodes[1].childNodes[1].classList.contains('effect-3')&&this.childNodes[1].childNodes[1].classList.contains('icon-img')){
                $(this).find(".hovicon").removeClass('effect-3 sub-b');
